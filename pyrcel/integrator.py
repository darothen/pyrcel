...
def integrate_parcel_arrays(
    ...
    Convenience wrapper around [integrate_parcel][] that unpacks the
...
def nd_from_parcel(
    ...
    *,
    ...
    Unlike the hard-threshold [Nd][pyrcel.model.ParcelModel.Nd] diagnostic, this
...
def integrate_parcel_terminated(
    ...
    *,
    ...
    ``jit``/``vmap``/``grad`` use the fixed-horizon [integrate_parcel][] /
    [find_smax][] / [max_supersaturation][] instead.
...
def integrate_parcel_chunked(
    ...
    *,
    ...
    Unlike [integrate_parcel][], this runs a Python loop over successive
